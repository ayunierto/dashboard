...
export const Components = () => {
  ...
  return (
    <>
      <h2 className="text-base dark:text-white">Buttons</h2>
      ...
      <div className="mb-4">
        <h2 className="dark:text-gray-200 ">Cards</h2>
        <div className="grid grid-cols-3 gap-2">
          <Card>Hello!!!</Card>
        </div>
      </div>
      ...
      <div className="">
        <h2 className="dark:text-gray-200">Dropdowns</h2>
      ...
      <div>
        <h2 className="dark:text-gray-200">Modal</h2>
        <Button onClick={openModal} variant="bordered">
          Open Modal
        </Button>
